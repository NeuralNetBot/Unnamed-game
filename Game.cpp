...
Game::Game(std::string title, bool fullscreen)
{
	...
	/*
	SphereGeneration generator;
	VertIndices e = generator.Generate(30, 5);
	
	Texture test;
	test.id = Utils::TextureFromFile("Earth.jpg", "C:/Users/conso/Pictures", false);;
	test.path = "C:/Users/conso/Pictures/idk123.png";
	test.type = "";
	std::cout << "texture id: " << test.id << std::endl;

	Mesh testmesh = Mesh(e.vertices, e.indices, {test});
	*/
	Shader shader("model_bloom.vs", "model_bloom.fs");
	...
	shader.setFloat("emission_strength", 100);
	shaderBlur.use();
	...
	Model spaceship = Model("D:/stuff idk/shiptex/ship.obj", false);

	spaceship.LoadMaterials("ship_diffuse.png", "ship_normal.png", "ship_emission.png");
	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		shader.setFloat("emission_strength", size);
		...
		//textrender.RenderText(textshader, "testing", 100, 100, 1, glm::vec3(1, 0, 0));
